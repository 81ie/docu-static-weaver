  ...
  return <motion.div className="card-wellness card-hover group" whileHover={{
    ...
    stiffness: 300
      ...
      <div className="relative aspect-square bg-wellness-lightBlue rounded-lg mb-4 overflow-hidden">
        ...
        duration: 0.3
      }} className="replace this image above \"meditation cushion\" with the attached one. also fix the error when i press on preview the website it comes up with an error\n " />
      </div>
