...
const ProductCard = ({
  ...
  return (
    <motion.div 
      className="card-wellness card-hover group" 
      whileHover={{
        y: -5
      }} 
      transition={{
    ...
    >
      <div className="relative aspect-square bg-wellness-lightBlue rounded-lg mb-4 overflow-hidden">
        <motion.img 
          src="/lovable-uploads/6c95d000-1052-4582-8788-2503e0b43a1f.png" 
          alt={title} 
          loading="lazy" 
          whileHover={{
            scale: 1.05
      ...
      <motion.button 
        className="flex items-center text-wellness-blue font-medium transition-colors" 
        whileHover={{
          color: '#34A853',
          x: 3
        }}
